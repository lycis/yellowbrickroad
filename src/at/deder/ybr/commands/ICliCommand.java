...
public interface ICliCommand {
	...
	/**
	 * Provides an accessor for the file system to the command. This will
	 * be needed if the command executes any interaction with the local file
	 * system (e.g. file input/output).
	 * 
